...
* [Zero-shot machine translation](results/tatoeba-results-all-subset-zero.md) (data: [zero](data/subsets/zero.md))
* [Low](results/tatoeba-results-all-subset-lower.md) and even [lower](results/tatoeba-results-all-subset-lowest.md) resource MT (data: [low](data/subsets/lower.md), [lower](data/subsets/lowest.md))
* [Medium](results/tatoeba-results-all-subset-medium.md), [higher](results/tatoeba-results-all-subset-higher.md) and [highest](results/tatoeba-results-all-subset-highest.md) resource MT (data: [medium](data/subsets/medium.md), [higher](data/subsets/higher.md), [highest](data/subsets/highest.md))
...
* [Bilingual training data](data/README-v2020-07-28.md) (v2020-07-28), language-pair specific downloads
* [Extra bilingual training data](data/subsets/NoTestData-v2020-07-28.md) (v2020-07-28), language-pair specific downloads
* [Monolingual data sets](data/MonolingualData-v2020-07-28.md), [with document boundaries](data/Wiki-v2020-07-28.md), [de-duplicated and shuffled](data/Wiki-v2020-07-28.md) (v2020-07-28)
