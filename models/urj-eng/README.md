...
* model: transformer-align
* pre-processing: normalization + SentencePiece (spm32k,spm32k)
* download: [opus1m+bt-2021-05-02.zip](https://object.pouta.csc.fi/Tatoeba-MT-models/urj-eng/opus1m+bt-2021-05-02.zip)
* test set translations: [opus1m+bt-2021-05-02.test.txt](https://object.pouta.csc.fi/Tatoeba-MT-models/urj-eng/opus1m+bt-2021-05-02.test.txt)
* test set scores: [opus1m+bt-2021-05-02.eval.txt](https://object.pouta.csc.fi/Tatoeba-MT-models/urj-eng/opus1m+bt-2021-05-02.eval.txt)

## Benchmarks

| testset | BLEU  | chr-F | #sent | #words | BP |
|---------|-------|-------|-------|--------|----|
| newsdev2015-enfi.fin-eng 	| 20.4 	| 0.489 	| 1500 	| 32104 	| 1.000 |
| newsdev2018-enet.est-eng 	| 23.9 	| 0.519 	| 2000 	| 43194 	| 1.000 |
| newssyscomb2009.hun-eng 	| 19.2 	| 0.476 	| 502 	| 11821 	| 0.950 |
| newstest2009.hun-eng 	| 18.1 	| 0.469 	| 2525 	| 65402 	| 0.962 |
| newstest2015-enfi.fin-eng 	| 22.0 	| 0.498 	| 1370 	| 27356 	| 0.986 |
| newstest2016-enfi.fin-eng 	| 23.4 	| 0.520 	| 3000 	| 63043 	| 1.000 |
| newstest2017-enfi.fin-eng 	| 26.0 	| 0.536 	| 3002 	| 61936 	| 0.992 |
| newstest2018-enet.est-eng 	| 24.4 	| 0.528 	| 2000 	| 45521 	| 1.000 |
| newstest2018-enfi.fin-eng 	| 19.1 	| 0.470 	| 3000 	| 62325 	| 0.983 |
| newstest2019-fien.fin-eng 	| 23.2 	| 0.507 	| 1996 	| 36227 	| 0.994 |
| newstestB2016-enfi.fin-eng 	| 19.4 	| 0.482 	| 3000 	| 63043 	| 0.991 |
| newstestB2017-enfi.fin-eng 	| 22.2 	| 0.505 	| 3002 	| 61936 	| 1.000 |
| newstestB2017-fien.fin-eng 	| 22.2 	| 0.505 	| 3002 	| 61936 	| 1.000 |
| Tatoeba-test.chm-eng 	| 1.6 	| 0.156 	| 71 	| 470 	| 1.000 |
| Tatoeba-test.est-eng 	| 52.5 	| 0.685 	| 1359 	| 8804 	| 0.972 |
| Tatoeba-test.fin-eng 	| 45.5 	| 0.633 	| 10000 	| 74643 	| 0.988 |
| Tatoeba-test.fkv-eng 	| 7.3 	| 0.375 	| 71 	| 652 	| 1.000 |
| Tatoeba-test.hun-eng 	| 43.7 	| 0.613 	| 10000 	| 69322 	| 0.977 |
| Tatoeba-test.izh-eng 	| 42.1 	| 0.615 	| 6 	| 23 	| 1.000 |
| Tatoeba-test.kom-eng 	| 1.4 	| 0.112 	| 15 	| 50 	| 1.000 |
| Tatoeba-test.krl-eng 	| 32.5 	| 0.483 	| 149 	| 710 	| 1.000 |
| Tatoeba-test.liv-eng 	| 3.0 	| 0.094 	| 33 	| 185 	| 1.000 |
| Tatoeba-test.mdf-eng 	| 1.0 	| 0.095 	| 7 	| 36 	| 1.000 |
| Tatoeba-test.multi-eng 	| 44.7 	| 0.621 	| 10000 	| 70413 	| 0.991 |
| Tatoeba-test.myv-eng 	| 0.5 	| 0.128 	| 25 	| 113 	| 1.000 |
| Tatoeba-test.sma-eng 	| 2.3 	| 0.107 	| 47 	| 219 	| 1.000 |
| Tatoeba-test.sme-eng 	| 7.1 	| 0.207 	| 62 	| 300 	| 1.000 |
| Tatoeba-test.udm-eng 	| 0.8 	| 0.147 	| 10 	| 49 	| 1.000 |
| Tatoeba-test.vro-eng 	| 46.6 	| 0.528 	| 5 	| 44 	| 1.000 |
...
* model: transformer
* source language(s): est fin fkv hun izh koi kom kpv krl liv mdf mhr mrj myv sma sme udm vot vro
* target language(s): eng
* model: transformer
* pre-processing: normalization + SentencePiece (spm32k,spm32k)
* download: [opus4m+btTCv20210807-2021-10-01.zip](https://object.pouta.csc.fi/Tatoeba-MT-models/urj-eng/opus4m+btTCv20210807-2021-10-01.zip)
* test set translations: [opus4m+btTCv20210807-2021-10-01.test.txt](https://object.pouta.csc.fi/Tatoeba-MT-models/urj-eng/opus4m+btTCv20210807-2021-10-01.test.txt)
* test set scores: [opus4m+btTCv20210807-2021-10-01.eval.txt](https://object.pouta.csc.fi/Tatoeba-MT-models/urj-eng/opus4m+btTCv20210807-2021-10-01.eval.txt)

## Benchmarks

| testset | BLEU  | chr-F | #sent | #words | BP |
|---------|-------|-------|-------|--------|----|
| newsdev2015-enfi.fin-eng 	| 21.3 	| 0.497 	| 1500 	| 32104 	| 0.988 |
| newsdev2018-enet.est-eng 	| 24.5 	| 0.527 	| 2000 	| 43194 	| 0.995 |
| newssyscomb2009.hun-eng 	| 20.2 	| 0.484 	| 502 	| 11821 	| 0.963 |
| newstest2009.hun-eng 	| 18.6 	| 0.475 	| 2525 	| 65402 	| 0.960 |
| newstest2015-enfi.fin-eng 	| 22.4 	| 0.505 	| 1370 	| 27356 	| 0.976 |
| newstest2016-enfi.fin-eng 	| 24.7 	| 0.528 	| 3000 	| 63043 	| 0.997 |
| newstest2017-enfi.fin-eng 	| 26.7 	| 0.542 	| 3002 	| 61936 	| 0.979 |
| newstest2018-enet.est-eng 	| 24.7 	| 0.533 	| 2000 	| 45521 	| 0.996 |
| newstest2018-enfi.fin-eng 	| 19.5 	| 0.477 	| 3000 	| 62325 	| 0.972 |
| newstest2019-fien.fin-eng 	| 24.2 	| 0.514 	| 1996 	| 36227 	| 0.973 |
| newstestB2016-enfi.fin-eng 	| 20.1 	| 0.489 	| 3000 	| 63043 	| 0.978 |
| newstestB2017-enfi.fin-eng 	| 23.1 	| 0.512 	| 3002 	| 61936 	| 0.989 |
| newstestB2017-fien.fin-eng 	| 23.1 	| 0.512 	| 3002 	| 61936 	| 0.989 |
| Tatoeba-test-v2021-08-07.multi-eng 	| 42.7 	| 0.601 	| 10000 	| 71389 	| 0.978 |
| Tatoeba-test-v2021-08-07.multi-multi 	| 42.7 	| 0.601 	| 10000 	| 71389 	| 0.978 |
...
* source language(s): chm est fin fkv_Latn hun izh koi kom kpv krl liv_Latn mdf mrj myv sma sme smn udm vot vot_Latn vro
* target language(s): eng
* raw source language(s): chm est fin fkv hun izh koi kom kpv krl liv mdf mrj myv sma sme smn udm vot vro
* raw target language(s): eng
* model: transformer-big
* pre-processing: normalization + SentencePiece (spm32k,spm32k)
* download: [opusTCv20230926max50+bt+jhubc_transformer-big_2024-08-17.zip](https://object.pouta.csc.fi/Tatoeba-MT-models/urj-eng/opusTCv20230926max50+bt+jhubc_transformer-big_2024-08-17.zip)
* test set translations: [opusTCv20230926max50+bt+jhubc_transformer-big_2024-08-17.test.txt](https://object.pouta.csc.fi/Tatoeba-MT-models/urj-eng/opusTCv20230926max50+bt+jhubc_transformer-big_2024-08-17.test.txt)
* test set scores: [opusTCv20230926max50+bt+jhubc_transformer-big_2024-08-17.eval.txt](https://object.pouta.csc.fi/Tatoeba-MT-models/urj-eng/opusTCv20230926max50+bt+jhubc_transformer-big_2024-08-17.eval.txt)

## Benchmarks

| testset | BLEU  | chr-F | #sent | #words | BP |
|---------|-------|-------|-------|--------|----|
| Tatoeba-test-v2023-09-26.multi-eng 	| 47.8 	| 0.65186 	| 10000 	| 75734 	| 0.977 |
