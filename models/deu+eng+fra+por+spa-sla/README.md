...
* target language(s): bel bos_Cyrl bos_Latn bul ces chu cnr cnr_Latn csb csb_Latn dsb hbs hbs_Cyrl hbs_Latn hrv hsb mkd orv_Cyrl pol rue rus slk slv srp_Cyrl szl ukr
* raw source language(s): deu eng fra por spa
* raw target language(s): bel bos bul ces chu cnr csb dsb hbs hrv hsb mkd orv pol rue rus slk slv srp szl ukr
* model: transformer-big
* pre-processing: normalization + SentencePiece (spm32k,spm32k)
* a sentence initial language token is required in the form of `>>id<<` (id = valid target language ID)
* valid language labels: 
* download: [opusTCv20230926max50+bt+jhubc_transformer-big_2024-05-29.zip](https://object.pouta.csc.fi/Tatoeba-MT-models/deu+eng+fra+por+spa-sla/opusTCv20230926max50+bt+jhubc_transformer-big_2024-05-29.zip)
...
|---------|-------|-------|-------|--------|----|
| Tatoeba-test-v2023-09-26.multi-multi 	| 43.8 	| 0.64962 	| 10000 	| 64735 	| 1.000 |
