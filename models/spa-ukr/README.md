...
* model: transformer-align
* pre-processing: normalization + SentencePiece (spm32k,spm32k)
* download: [opus-2021-02-12.zip](https://object.pouta.csc.fi/Tatoeba-MT-models/spa-ukr/opus-2021-02-12.zip)
* test set translations: [opus-2021-02-12.test.txt](https://object.pouta.csc.fi/Tatoeba-MT-models/spa-ukr/opus-2021-02-12.test.txt)
* test set scores: [opus-2021-02-12.eval.txt](https://object.pouta.csc.fi/Tatoeba-MT-models/spa-ukr/opus-2021-02-12.eval.txt)
...
|-----------------------|-------|-------|
| Tatoeba-test.spa.ukr 	| 41.3 	| 0.614 |
| Tatoeba-test.spa-ukr.spa.ukr 	| 41.3 	| 0.614 |
