...
* model: transformer-align
* pre-processing: normalization + SentencePiece (spm4k,spm4k)
* download: [opus-2021-02-11.zip](https://object.pouta.csc.fi/Tatoeba-MT-models/run-eng/opus-2021-02-11.zip)
* test set translations: [opus-2021-02-11.test.txt](https://object.pouta.csc.fi/Tatoeba-MT-models/run-eng/opus-2021-02-11.test.txt)
* test set scores: [opus-2021-02-11.eval.txt](https://object.pouta.csc.fi/Tatoeba-MT-models/run-eng/opus-2021-02-11.eval.txt)
...
|-----------------------|-------|-------|
| Tatoeba-test.run.eng 	| 26.7 	| 0.428 |
| Tatoeba-test.run-eng.run.eng 	| 26.7 	| 0.428 |
